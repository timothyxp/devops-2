...
class SortPriceVertex implements Comparable {
    ...
    SortPriceVertex(int fromVertex, double cost) {
        this.fromVertex = fromVertex;
        this.cost = cost;
    }
    ...
    public int compareTo(Object o) {
        SortPriceVertex other = (SortPriceVertex)o;
...
//        ArrayList<Boolean> usedVertices = new ArrayList<>(maxVertex + 1);
    ...
    public double getLegCost(Order order, Leg leg) {
        ...
        return leg.getBasePrice() + order.getOverallPrice(); // stub
    }
}
